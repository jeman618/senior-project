...
function About() {
    return (
        ...
        <div className="middle">
            <img className="about-img" src="/senior-project/images/farmers.png" alt="Farmers picking crops"/>
            ...
            <img className="logo-img" src="/senior-project/images/logo.png" alt="GardenGuru's Logo"/>
        </div>
        </>
    );
}
